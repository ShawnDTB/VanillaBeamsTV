...
const linkingSteps = [
  ...
  "You can verify your linked by using /discord linked ingame",
];
...
const perkHighlights = [
  ...
  {
    icon: ShieldCheck,
    title: "Tiered supporter benefits",
    text: "Each tier builds on the last so there is a real reason to support while keeping gameplay balanced.",
  },
];
